...
public class ColeccionRegistros extends Identifiable {
    ...
    /**
     * Relación muchos-a-uno con la tabla de asistencia diaria.
    ...
    /**
    * método adicional para mostrar el día de la semana en español.
     */
    @Transient
    @ReadOnly
    @Depends("fecha")
    ...
    /**
     * Coordenada geográfica (lat, lon), u otro identificador de ubicación.
     */
    @ReadOnly
    @Coordinates 
    @Column(length = 50)
    ...
    /**
     * Observación o comentario adicional del registro.
     */
    @TextArea
