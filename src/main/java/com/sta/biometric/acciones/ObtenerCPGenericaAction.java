...
public class ObtenerCPGenericaAction extends ViewBaseAction {
	...
	public void execute() throws Exception {
		...
		if (!(direccionObj instanceof Direccion)) {
			addError("El metodo getDireccion() no devuelve un objeto de tipo Direccion.");
			return;
		}
		...
		// No incluir cÃ³digo postal porque aÃºn no lo tenemos
