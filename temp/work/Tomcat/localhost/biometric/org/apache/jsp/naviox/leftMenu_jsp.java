 ...
 * Generated at: 2025-12-15 23:19:34 UTC
...
public final class leftMenu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1765840760323L));
    _jspx_dependants.put("/WEB-INF/openxava.tld", Long.valueOf(1763155074000L));
    _jspx_dependants.put("/naviox/organizationNameExt.jsp", Long.valueOf(1763155074000L));
  }
 ...
 if (modules.showsSearchModules(request)) { 
      ...
      out.write("                    ");
                    ...
                    // Iteramos sobre cada mï¿½dulo y lo imprimimos si no estï¿½ en la lista de ocultos
                    for (Object moduleObj : listaModulos) {
                        String moduleName = moduleObj.toString().replace("MetaModule: ", "");

                        // Verificamos si el mï¿½dulo no estï¿½ en la lista de ocultos
                        if (!modulosOcultos.contains(moduleName)) {
                            // Dividimos el nombre del mï¿½dulo y tomamos solo la parte despuï¿½s de la barra "/"
      ...
      // /naviox/leftMenu.jsp(96,31) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (!isFirstSteps) { 
  ...
  private boolean _jspx_meth_xava_005flabel_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /naviox/leftMenu.jsp(61,20) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_xava_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /naviox/leftMenu.jsp(73,79) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
