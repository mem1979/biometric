 ...
 * Generated at: 2025-12-07 16:26:58 UTC
...
if (editable) {
	...
	if (conf != null) cssClass = "ox-" + conf + "-html-text"; 
      ...
      out.write('\r');
      out.write('\n');
      String _jspx_temp0_url = "textAreaEditor.jsp";
      String _jspx_temp0_requestEncoding = request.getCharacterEncoding();
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, _jspx_temp0_url + ((_jspx_temp0_url).indexOf('?')>0? '&': '?') + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("cssClass", _jspx_temp0_requestEncoding)+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(cssClass), _jspx_temp0_requestEncoding), out, false);
      out.write('\r');
      out.write('\n');
